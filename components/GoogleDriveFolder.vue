...
export default {
  ...
  methods: {
    ...
    getFolderContentsByFolderId(folderId, loadMore = false) {
      ...
      vm.loading = true;
      fetch(
        `https://www.googleapis.com/drive/v3/files?q='${folderId}' in parents&orderBy=folder asc,name&key=AIzaSyDHbDkDUqv39yqYtBI5XD7arA2L8LEzgko&pageToken=${this.nextPageToken ? this.nextPageToken : ''}`
      )
