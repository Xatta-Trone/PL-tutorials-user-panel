  ...
  <div>
    ...
    <b-container>
      <b-row class="text-left py-1 my-5">
        ...
        <b-col sm="5">
          <p>Links:: Since, we do not have any physical address <font-awesome-icon :icon="['far', 'smile-wink']"
            /></p>
          <b-list-group v-for="links in socialLinks" :key="links.key">
            ...
            <b-list-group-item
              ...
              {{ links.value }}</b-list-group-item
            >
            <b-list-group-item v-if="links.key == 'youtube'" :href="links.value" _target="blank"><font-awesome-icon :icon="['fab', 'youtube']"
            /> {{ links.value }}</b-list-group-item>
            <b-list-group-item v-if="links.key == 'messenger'"
              :href="links.value"
              _target="blank"><font-awesome-icon :icon="['fab', 'facebook-messenger']"
            /> {{ links.value }}</b-list-group-item>
