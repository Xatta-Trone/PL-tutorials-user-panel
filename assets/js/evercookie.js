    ...
    function Evercookie(options) {
      ...
      if (_ec_hsts) {
        if (opts.hsts_domains.length <= 8) {
          ...
          console.log(
            "HSTS cookie with " +
              opts.hsts_domains.length +
              " can only save values up to " +
              Math.pow(2, opts.hsts_domains.length) -
              1
          );
        }
      ...
      this._evercookie = function (name, cb, value, i, dont_reset) {
        ...
        // when reading data, we need to wait for swf, db, silverlight, java and png
          ...
          if (
            ...
            ((opts.db &&
              window.openDatabase &&
              typeof self._ec.dbData === "undefined") ||
              (opts.idb &&
                idb() &&
                (typeof self._ec.idbData === "undefined" ||
                  self._ec.idbData === "")) ||
              ...
              (opts.pngCookieName &&
                ...
                (typeof self._ec.pngData === "undefined" ||
                  self._ec.pngData === "")) ||
          ...
          // we hit our max wait time or got all our data
            ...
            for (item in tmpec) {
              if (
                ...
                candidates[tmpec[item]] =
                  candidates[tmpec[item]] === undefined
                    ? 1
            ...
            if (
              candidate !== undefined &&
              (dont_reset === undefined || dont_reset !== 1)
            ) {
      ...
      this.evercookie_lso = function (name, value) {
        ...
        swfobject.embedSWF(
          _ec_baseurl + _ec_asseturi + _ec_swf_file_name,
          "swfcontainer",
          "1",
          "1",
          "9.0.0",
      ...
      this.evercookie_silverlight = function (name, value) {
        ...
        if (value !== undefined) {
          initParam =
            '<param name="initParams" value="' + name + "=" + value + '" />';
        }
        ...
        html =
          ...
          '<a href="http://go.microsoft.com/fwlink/?LinkID=149156&v=' +
          minver +
          '" style="display:none">' +
